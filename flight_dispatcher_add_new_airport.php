      ...
      <form action="include/flight_dispatcher_add_new_airport.inc.php" method="POST" class="was-validated" id="add_new_airport_form">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-4">
            ...
            <input oninput="checkDuplicatesAirportCode('airport_code_val','include/flight_dispatcher_add_new_airport.inc.php','airport_code_',this.value)" required class="form-control" type="text" name="airport_code" id="airport_code" placeholder="Enter Airport Code">
