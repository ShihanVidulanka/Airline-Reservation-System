...
function checkPassportNo() {
    ...
    let current_passport_number = document.getElementById('current_passport_no').value;
    let errormsg = document.getElementById('passport_number_val');
    ...
    if (passport_number.length == 0) {
        ...
        return;
    }else if(passport_number==current_passport_number){
        ...
        xhttp.open("POST", "include/passenger_edit_details.inc.php", true);
